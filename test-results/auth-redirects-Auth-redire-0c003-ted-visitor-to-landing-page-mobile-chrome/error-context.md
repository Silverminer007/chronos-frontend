...
- Name: auth-redirects.spec.ts >> Auth redirects >> /settings redirects unauthenticated visitor to landing page
...
Call log:
  - navigating to "http://localhost:3000/settings", waiting until "domcontentloaded"
