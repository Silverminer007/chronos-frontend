...
- Name: auth-redirects.spec.ts >> Auth redirects >> /agenda redirects unauthenticated visitor to landing page
- Location: e2e/auth-redirects.spec.ts:14:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/agenda
Call log:
  - navigating to "http://localhost:3000/agenda", waiting until "domcontentloaded"
